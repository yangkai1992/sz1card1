...
<body id="leftMenu" onload="DefaltExpand()">
    ...
    <div id="Topdiv">
        <table id="Str" width="147" height="100%" border="0" align="center" cellpadding="0"
            cellspacing="0">
            <asp:XmlDataSource ID="xmlDSMenu" runat="server" XPath="siteMap/menu" EnableCaching="false">
            </asp:XmlDataSource>
                    ...
                    <tr>
                        <td>
                            <table title="" id="table3<%# XPath("id")%>" width="100%" border="0" cellspacing="0"
                                cellpadding="0" style="height: 100%; border: 1px solid #c5ddff; display: none;
    ...
    <div id="downdiv" style="width: 100%; background-image: url('../images/main_69.gif');
        position: absolute; bottom: 0px;" align="center">
