...
namespace sz1card1.Common.Security
{
    ...
    public class RSAUtil
    {
        ...
        public static string Sign(string content, string privateKey, string input_charset)
        {
            ...
            RSACryptoServiceProvider rsa = LoadCertificatePEM(privateKey);
        ...
        /// <returns></returns>
        private static RSACryptoServiceProvider LoadCertificatePEM(string privateKeyPem)
        {
            try
            {
                RSACryptoServiceProvider rsa = DecodeRSAPrivateKey(Convert.FromBase64String(privateKeyPem));
                return rsa;
            }
            catch (Exception)
            {
